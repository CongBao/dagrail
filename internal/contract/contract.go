...
func Current() Report {
	...
	return Report{
		...
		Graph: GraphSurface{
			...
			Capabilities: []string{"controlled-role-transfer", "declared-lanes", "dynamic-graph", "hierarchical-subgraphs", "historical-lifecycle-import", "lifecycle-projection", "positive-predicate-ast", "resource-capacities", "resource-requests", "role-leases"},
		},
		...
		Promises: []string{
			...
			"the v0.10.0 through v0.26.5 beta binaries are immutable inputs to the current upgrade and rollback matrix",
