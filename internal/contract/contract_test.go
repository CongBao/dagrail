...
func TestBetaContractIsDeterministicAndNamesExactlySixMCPTools(t *testing.T) {
	...
	wantCapabilities := []string{"controlled-role-transfer", "declared-lanes", "dynamic-graph", "hierarchical-subgraphs", "historical-lifecycle-import", "lifecycle-projection", "positive-predicate-ast", "resource-capacities", "resource-requests", "role-leases"}
